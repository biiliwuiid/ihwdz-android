...
import com.ihwdz.android.hwapp.utils.InterceptorUtils;
import com.ihwdz.android.hwapp.utils.JsonUtils;
...
//        builder.addInterceptor(InterceptorUtils.getCacheInterceptor());
    ...
    private static GsonConverterFactory buildGsonConverterFactory(){
        ...
        // duan
        builder.registerTypeAdapter(HomePageData.class, new JsonDeserializer<HomePageData>() {
            @Override
            public HomePageData deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)  {
                if (json == null){
                    return null;
                }else {
                    return new HomePageData(json.getAsJsonArray());

                }
            }
        });

//        builder.registerTypeAdapter(MarketPriceData.class, new JsonDeserializer<MarketPriceData>() {
//            @Override
//            public MarketPriceData deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)  {
//                if (json == null){
//                    return null;
//                }else {
////                    return new MarketPriceData(json.getAsJsonArray());
//                    return null;
//
//                }
//            }
