...
public class RecordsActivity extends BaseActivity implements RecordContract.View, SwipeRefreshLayout.OnRefreshListener{

    String TAG = "RecordsActivity";
    ...
    @Inject RecordContract.Presenter mPresenter;
    ...
    public void initData() {
        ...
        switch (Constant.VIP_TYPE){
            ...
            case 1:
                // 交易会员
                mPresenter.setCurrentMode(DEAL_MODE);
                mPresenter.getRecordData();
                break;
            case 2:
                // 商家会员
                mPresenter.setCurrentMode(SHOP_MODE);
                mPresenter.getShopRecordData();
                break;
            default:
                showEmptyView();
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == InvoiceRequestCode){
    ...
    public void onActivityReenter(int resultCode, Intent data) {
        Log.d(TAG, "====================   ===================  onActivityReenter1");
        super.onActivityReenter(resultCode, data);
        if (resultCode == InvoiceRequestCode){
            Log.d(TAG, "====================   ===================  onActivityReenter2");
        }
    }
    ...
    private void initToolBar() {
        ...
        title.setText(getResources().getString(R.string.title_trade_records));
    }
    ...
    private void initRecyclerView() {
        ...
        mPresenter.getAdapter().addItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemChecked(String totalAmount, String orderId) {
                mPresenter.setAmount(totalAmount);
                mPresenter.setOrderId(orderId);
                mPresenter.gotoInvoiceInfo();
                Log.d(TAG, "================= onItemChecked - orderId: "+orderId);
