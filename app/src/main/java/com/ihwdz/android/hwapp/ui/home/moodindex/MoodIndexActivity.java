...
public class MoodIndexActivity extends BaseActivity {

    static String TAG = "MoodIndexActivity";

    static final String SELECT_INDEX = "selectIndex";

    // String url = "http://mb.ihwdz.com/ios/breed_index.html";  // 首页情绪指数
    String url = HwApi.MOOD_INDEX_URL;
...
//    TextView title;
    ...
    public int getContentView() {
        return R.layout.activity_mood_index;
    }

    @Override
    public void initView() {
        backBt.setVisibility(View.VISIBLE);
        // title.setText(getResources().getString(R.string.mood_index_title));
        initWebView();
    ...
    public static void startMoodIndexActivity(Context context) {
        Log.i(TAG, "=================================== startIndexWebActivity ===================");
        Intent intent = new Intent(context, MoodIndexActivity.class);
    ...
    private WebViewClient webViewClient = new WebViewClient(){
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(url.equals("http://www.google.com/")){
                Toast.makeText(MoodIndexActivity.this,"国内不能访问google,拦截该url",Toast.LENGTH_LONG).show();
