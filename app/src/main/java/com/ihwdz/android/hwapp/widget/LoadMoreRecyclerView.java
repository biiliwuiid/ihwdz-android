...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    private static final int STATUS_DISMISS = 4;
    ...
    private static class LoadMoreAdapter extends Adapter {
        ...
        public void onViewAttachedToWindow(ViewHolder holder) {
            ...
            if (mIsLoadMore) {// 如果加载更多
                // set SpanSizeLookup for GridLayoutManager
                ...
                if (params instanceof StaggeredGridLayoutManager.LayoutParams) {
                    if (holder.getLayoutPosition() == getItemCount() - 1) { // 当position为最后一项时  -> FullSpan为true
        ...
        public ViewHolder onCreateFooterViewHolder(ViewGroup parent) {
            return new FooterViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.foot_view, parent, false));
        }
