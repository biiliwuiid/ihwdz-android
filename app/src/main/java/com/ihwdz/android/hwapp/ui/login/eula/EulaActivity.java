...
public class EulaActivity extends BaseActivity {
    ...
    static String TAG = "EulaActivity";
    ...
    String serviceUrl = HwApi.SERVICE_URL;   //服务条款H5
    String privacyUrl = HwApi.PRIVACY_URL;   //隐私协议H5  Privacy Policy

    String titleStr = "";
    static final String SELECT_INDEX = "selectIndex";
    static final String MODE_NOTE = "mode_note";       // 服务条款 0；隐私协议 1
    ...
    public static void startEulaActivity(Context context, String titleStr, int mode) {
        Log.i(TAG, "=================================== startEulaActivity ===================");
        Intent intent = new Intent(context, EulaActivity.class);
        ...
        intent.putExtra(SELECT_INDEX, titleStr);
    ...
    private void initWebView() {
        // 服务条款 0；隐私协议 1
        if (currentMode == 0){
            webView.loadUrl(serviceUrl);   // 服务条款 0
        }else if (currentMode == 1){
            webView.loadUrl(privacyUrl);   // 隐私协议 1
        }
    ...
    private WebViewClient webViewClient = new WebViewClient(){
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(url.equals("http://www.google.com/")){
                Toast.makeText(EulaActivity.this,"国内不能访问google,拦截该url",Toast.LENGTH_LONG).show();
