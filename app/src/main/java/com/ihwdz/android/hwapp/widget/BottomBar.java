...
public class BottomBar extends View {
    ...
    public BottomBar setContainer(int containerIdt){
        this.containerId = containerIdt;
        return this;
    }
...
//    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        //果断为false，然后就再也进不到循环取子view的步骤了，直接调用dispatch-
        // TransformedTouchEvent并传子view为null，所以直接调用view group自身的dispatch-
        // TouchEvent了
    }
