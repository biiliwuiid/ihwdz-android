...
public class AdvertisementActivity extends BaseActivity {
    ...
    static String TAG = "AdvertisementActivity";

    String adUrl ="http://172.16.10.39:8082/cms-h5/android/invitation.html";  // TEST
   // String adUrl ="http://mb.ihwdz.com/android/invitation.html";              //11月9号的会议活动
    ...
    private void initToolBar() {
        ...
        title.setText(getResources().getString(R.string.title_ad));
    }
    ...
    private WebViewClient webViewClient = new WebViewClient(){
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(url.equals("http://www.google.com/")){
                Toast.makeText(AdvertisementActivity.this,"国内不能访问google,拦截该url",Toast.LENGTH_LONG).show();
